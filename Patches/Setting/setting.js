        ...
        const SECTIONS = [
            {
                name: 'Keyboard', priority: 1, settings: [
                    ...
                    { type: Ui.ComponentType.Slider, id: 'XSOverlayFontChanger.KeyboardSize', name: 'Scale', description: 'Keyboard font scale.', default: 0, options: [-20, 20, 2], unit: 'Pixel' },
                ]
            },
            {
                name: 'Notification', priority: 2, settings: [
                    ...
                    { type: Ui.ComponentType.Slider, id: 'XSOverlayFontChanger.NotificationSize', name: 'Scale', description: 'Notification font scale.', default: 0, options: [-20, 20, 2], unit: 'Pixel' },
                ]
            },
            {
                name: 'Settings', priority: 3, settings: [
                    ...
                    { type: Ui.ComponentType.Slider, id: 'XSOverlayFontChanger.SettingsSize', name: 'Scale', description: 'Settings font scale.', default: 0, options: [-20, 20, 2], unit: 'Pixel' },
                ]
            },
            {
                name: 'Tooltip', priority: 4, settings: [
                    ...
                    { type: Ui.ComponentType.Slider, id: 'XSOverlayFontChanger.TooltipSize', name: 'Scale', description: 'Tooltip font scale.', default: 0, options: [-20, 20, 2], unit: 'Pixel' },
                ]
            },
            {
                name: 'WindowSettings', priority: 5, settings: [
                    ...
                    { type: Ui.ComponentType.Slider, id: 'XSOverlayFontChanger.WindowSettingsSize', name: 'Scale', description: 'Window Overlay font scale.', default: 0, options: [-20, 20, 2], unit: 'Pixel' },
                ]
            },
            {
                name: 'Wrist', priority: 6, settings: [
                    ...
                    { type: Ui.ComponentType.Slider, id: 'XSOverlayFontChanger.WristSize', name: 'Scale', description: 'Wrist font scale.', default: 0, options: [-20, 20, 2], unit: 'Pixel' },
                ]
            },
            {
